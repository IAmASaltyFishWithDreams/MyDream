...
void Logger::setControl(int32 control) {
    m_logControl |= control;
}

void Logger::unsetControl(int32 control) {
    m_logControl ^= control;
}

void Logger::output(LogControl level, const char* file, int32 line, const char* func, const char* format, ...) {
